	...
	return function(e) {
		...
		t.default = {
				...
				sortOrders: {
					...
					validator: function(e) {
						return e.every(function(e) {
							return ["asc", "desc", null].indexOf(e) > -1
						})
					}
				},
				autoExpand: {
			...
			computed: {
				...
				winIsXs: function() {
					return this.$root.$el.clientWidth < 768;
				}
			},
			created: function() {
				var e = this;
				...
				var l = o.renderCell,
					u = this;
				if (o.sortable === "custom") {
					if (!u.$root.sal) {
						u.$root.sal = {};
					}
					if (!u.$root.sal.sortables) {
						u.$root.sal.sortables = [];
					}
					u.$root.sal.sortables.push(o);
				}
				if (o.autoExpand === true && u.winIsXs) {
					o.renderCell = function(h, data) {
						return ''
					};
					o.renderHeader = function(h, data) {
						return ''
					};
					if (!u.owner.sal) {
						u.owner.sal = {};
					}
					if (!u.owner.sal.autoExpands) {
						u.owner.sal.autoExpands = [];
					}
					o.renderAutoExpand = function(h, data) {
						if (u.$scopedSlots.default) {
							return u.$scopedSlots.default(data);
						} else {
							return h("span", data.row[o.property]);
						}
					}
					// o.defaultSlots = u.$scopedSlots.default;
					if (u.isSubColumn) {
						var index = u.owner.sal.autoExpands.indexOf(u.columnOrTableParent.columnConfig);
						if (index > -1) {
							u.owner.sal.autoExpands[index] = o;
							return;
						}
					}
					u.owner.sal.autoExpands.push(o);
					return;
				}
			...
			mounted: function() {
				...
				n = this.isSubColumn ? [].indexOf.call(i.$el.children, this.$el) : [].indexOf.call(i.$refs.hiddenColumns.children,
					...
					}), (this.autoExpand !== true || !this.winIsXs) ? t.store.commit("insertColumn", this.columnConfig, n, this
					.isSubColumn ? i.columnConfig : null) : null
			}
		}
	}, function(e, t, i) {
		"use strict";
